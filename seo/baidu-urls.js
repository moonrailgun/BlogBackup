...
inquirer
    .prompt([
        ...
        },
        {
            ...
            name: 'token',
            message: '百度Token',
            default: fs.existsSync(tokenCachePath) ? fs.readFileSync(tokenCachePath, { encoding: 'utf8' }) : undefined
        },
    ])
    .then(answers => {
        ...
        const target = "http://data.zz.baidu.com/urls?site=" + site + "&token=" + token;
